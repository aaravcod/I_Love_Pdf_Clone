...
router.post("/", upload.single("pptFile"), (req, res) => {
    if (!req.file) {
    ...
    // Call the Python script for PPT to PDF
    const pythonProcess = spawn("python", ["backend/services/ppttopdf.py", inputFilePath, outputFilePath]);
